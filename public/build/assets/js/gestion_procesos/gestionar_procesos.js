...
const app = Vue.createApp({
    ...
    <editar_proceso v-if="editarProceso" @ocultarEditarProceso="ocultaEditarProceso" @retornarGestionProcesos="retornaGestionProcesos" :puesto_trabajo="datosProcesoEdicion[0]" :ubicacion="datosProcesoEdicion[1]" :provincia="datosProcesoEdicion[2]" :tipo_trabajo="datosProcesoEdicion[3]" :sector="datosProcesoEdicion[4]" :descripcion="datosProcesoEdicion[5]" :estudios_minimos="datosProcesoEdicion[6]" :experiencia_minima="datosProcesoEdicion[7]" :jornada="datosProcesoEdicion[8]" :turno="datosProcesoEdicion[9]" :numero_vacantes="datosProcesoEdicion[10]" :salario="datosProcesoEdicion[11]" :fecha_cierre="datosProcesoEdicion[12]" :estado="datosProcesoEdicion[13]" :referencia="datosProcesoEdicion[14]"></editar_proceso>
    `,
    components: {
        proceso,
        numeracion_slider,
